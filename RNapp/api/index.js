...
mongoose
    .connect("mongodb+srv://sayakbasakhack:3cR1zKEh570CR4RG@cluster0.cx7eix7.mongodb.net/?retryWrites=true&w=majority", {
...
app.post("/register", async (req, res) => {
    try {
        ...
        //create a new user
        const newUser = new User({ name, email, password,phone,gender,source,city,state });
